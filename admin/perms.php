...
if (!isset($_REQUEST['op'])) {
    ...
    amrev_adminmenu(4, _AM_AMREV_PERMS);

    /**
     * For my reference, and anyone else's - how to use group perms:
     * https://www.xoops.org/modules/newbb/viewtopic.php?topic_id=12230&viewmode=flat&order=ASC&start=0
     */
    ...
    */
    ...
    if ($xoopsDB->getRowsNum($result) > 0) {
        while (false !== ($myrow = $xoopsDB->fetchArray($result))) {
            ...
            $categories1[$key] = ['name' => $myts->displayTarea($myrow['cat_title'], 0, 0, 0, 0, 0), 'parent' => (int)$myrow['cat_parentid']];

 ...
 */
if (isset($comments) and '0' == $comments) {
    $comment_checked = '0';
} else {
    $comment_checked = '1';
}
 ...
 */
if (isset($nosmiley) and '0' == $nosmiley) {
    $nosmiley_checked = '0';
} else {
    $nosmiley_checked = '1';
}
 ...
 */
if (isset($noxcode) and '0' == $noxcode) {
    $noxcode_checked = '0';
} else {
    $noxcode_checked = '1';
}
 ...
 */
if (isset($noimage) and '0' == $noimage) {
    $noimage_checked = '0';
} else {
    $noimage_checked = '1';
}

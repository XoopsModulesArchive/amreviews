...
require_once '../class/image_resizerGD.class.php';
...
if (!isset($_REQUEST['op'])) {
    ...
    amrev_adminmenu(3, _MI_AMREV_IMAGES);
...
if (isset($_REQUEST['op']) and 'upload' == $_REQUEST['op']) {
    xoops_cp_header();
...
if (isset($_REQUEST['op']) and 'delimage' == $_REQUEST['op']) {
    //xoops_cp_header();
    ...
    if (!isset($_REQUEST['subop'])) {
        ...
        if (0 == amr_checkImageInUse($image_filename)) {
            #echo _AM_AMREV_IMGCONFDEL;
        ...
        xoops_confirm(['op' => 'delimage', 'image_file' => $image_filename, 'subop' => 'delok'], 'image.php', $confirm_msg);

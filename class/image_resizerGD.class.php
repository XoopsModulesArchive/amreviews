...
class thumbnails
{
    public function create($photopath, $thumbnailpath, $filename, $thumbwidth = '180', $extention = '1')
    {
        ...
        if (('image/gif' == $imagesize['mime']) and ($gdinfo['GIF Read Support'])) {
        ...
        $thumbinfo = ['thumbwidth' => $thumbwidth, 'thumbheight' => $thumbheight, 'thumbnail' => $thumbfilename];
